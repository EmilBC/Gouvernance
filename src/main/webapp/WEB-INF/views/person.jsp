                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form:form action="${addAction}" commandName="project">
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1" class="form-label">Git Repo's</label>
                                                <br>
                                                <form:input style="width:100%" data-role="tagsinput" type="text" path="git" class="form-control" aria-describedby="emailHelp"/>

                                                <div id="emailHelp" class="form-text">Use Enter to set multi values</div>
                                            </div>
